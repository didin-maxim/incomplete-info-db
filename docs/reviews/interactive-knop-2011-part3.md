...
- Естественные кандидаты для будущих вероятностных задач: `ten-row-fakes-on-right-two-weighings`, `knop-2011-row-fakes-right-optional-k-weighings`, `nine-circle-two-adjacent-light-two-weighings`, `nine-circle-three-consecutive-light-two-weighings` и `nine-circle-arithmetic-progression-find-heaviest-two-weighings`. У них конечное равномерное пространство состояний из 9 случаев, поэтому можно обсуждать ожидаемую длину адаптивной стратегии или максимизацию ожидаемого успеха при одном взвешивании.
