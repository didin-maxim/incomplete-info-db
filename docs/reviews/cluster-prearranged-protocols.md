...
## Внешние русскоязычные материалы

2026-05-24 добавлен машинно-читаемый список `resources-prearranged-protocols-ru-2026-05-24` в `data/resources/external_ru_resources.yaml`. Это не очередь новых карточек, а curated layer для школьника и составителя.

- ЦПМ, 7 класс, `Кооперативные стратегии`: кружковый листок по мудрецам, карточным фокусам и кодированию короткого сигнала.
- ЦПМ, 10 класс, `Кооперативные стратегии`: более старший листок с вероятностными стратегиями, пасом/угадыванием и задачами про заключенных.
- МЦНМО, `Фокусы!`: младший листок по карточным фокусам, порядку как каналу и XOR-перевороту одной монеты.
- А. Эвнин, `Задачи о фокусниках и теоремы Холла и Шпернера`, «Квант», 2019, №2: теоретическая основа для фокусников и паросочетаний.
- С. Грибок, `Мудрецы, колпаки и арифметика конечных полей`, «Квант», 2019, №4: старший фон для колпаков, кодов и вероятностных стратегий.
- `Многократная лемма Холла в задачах про мудрецов`, «Квант», 2019, №7: обобщения и связь с задачей про шесть гномов и семь радужных колпаков.
