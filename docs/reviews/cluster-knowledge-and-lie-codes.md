# Обзор: публичное знание и коды против лжи/ошибок
...
- `questions-with-lies-and-error-correction`: ответы рассматриваются как слово с возможными искажениями; ложь, ошибка, молчание или стирание требуют избыточности кода.
...
## Коды Против Лжи И Ошибок: Критерии
