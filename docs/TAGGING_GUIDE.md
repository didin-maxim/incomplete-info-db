...
| `hat_puzzle` | Условие про колпаки/цвета на участниках и ограниченное наблюдение. | Есть люди и цвета, но не модель с колпаками. | `hat-line-k-colors-modulo` | `blue-eyed-islanders` |
